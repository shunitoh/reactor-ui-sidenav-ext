...
var _IconTextSchemeMixin = __webpack_require__(11);
...
var Nav = function () {
  function Nav() {
    ...
    this.mixins = [_IconTextSchemeMixin2.default, _reactAddonsPureRenderMixin2.default];
  }
...
var lodash = __webpack_require__(47);
var Nav = __webpack_require__(17);
var ChildNavGroup = __webpack_require__(28);
var IconTextSchemeMixin = __webpack_require__(11);
var cn = __webpack_require__(13);
var PureRenderMixin = __webpack_require__(12);
        ...
        if (this.props.nav) {
            return this.props.nav.navlist.map(function (nav) {
                ...
                if (nav.navlist) {
                    ...
                    return React.createElement(Nav, _extends({ key: nav.id }, { selectedId: _this.props.selectedId }, { selected: _this.state.selected }, nav, { onClick: _this.onSubNavClick }, { group: nav.id }, { words: _this.props.words }));
                }
            });
        } else {
...
module.exports = {
    SideNav: __webpack_require__(31),
    Nav: __webpack_require__(17),
    NavGroup: __webpack_require__(26),
    ChildNavGroup: __webpack_require__(28),
    ChildNav: __webpack_require__(29)
};
...
var NavGroup = __webpack_require__(26);
var Nav = __webpack_require__(17);
...
var SideNav = function (_React$Component) {
    ...
    function SideNav(props) {
        ...
        _this2.onSubNavClick = function (group, child, options) {
            var selection = { group: group, id: child, options: options };
            _this2.setState({ selected: selection });
            _this2.dispatchSelection(selection);
        };

        _this2.onClick = function (id, options) {
            var selection = { id: id, options: options };
            _this2.setState({ selected: selection });
            _this2.dispatchSelection(selection);
        };

        _this2.dispatchSelection = function (selection) {
            if (_this2.props.onSelection) {
                _this2.props.onSelection(selection);
            }
        };
        ...
        value: function buildFromSettings() {
            ...
            return this.props.navs.map(function (navkind) {
                ...
                if (navkind.navlist) {
                    ...
                    return React.createElement(Nav, _extends({ key: navkind.id }, { id: navkind.id }, { selectedId: _this.state.selected.id }, { selected: _this.state.selected }, navkind, { onClick: _this.onClick }, { group: navkind.id }, { words: words }));
                }
            });
        }
    }, {
